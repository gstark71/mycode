#!/usr/bin/python3
"""Stark Labs | Gstark - script writen by Alta3 Research || Author RZFeeser@alta3.com
Learning how to use functions"""

# for installing crayons package (crayons is for adding colored text to your output)
# use python3 -m pip install crayons 
